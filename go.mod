...
require (
	...
	go4ml.xyz/dyl v0.0.0-20220319211442-0bcd121b5a89
...
require (
	...
	go4ml.xyz/errstr v0.0.0-20220319161933-fddf66371f9a // indirect
	go4ml.xyz/fu v0.0.0-20220319164044-312fabe3aeaf // indirect
